    ...
    return (
        <section className="section" style={{padding: '0'}}>
            ...
            data-netlify-honeypot="bot-field"  novalidate>
                    ...
                    <div className="mc-field-group size1of2">
                        <label for="mce-PHONE">Phone Number  <span className="asterisk">*</span></label>
